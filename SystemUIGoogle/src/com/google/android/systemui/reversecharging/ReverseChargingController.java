...
@SysUISingleton
public class ReverseChargingController extends BroadcastReceiver
        implements CallbackController<ReverseChargingChangeCallback> {
    ...
    private final AlarmManager.OnAlarmListener mCheckNfcConflictWithUsbAudioAlarmAction =
            new AlarmManager.OnAlarmListener() {
                @Override
                public void onAlarm() {
                    if (mUsbManagerOptional.isPresent()) {
                        for (UsbDevice usbDevice :
                                mUsbManagerOptional.get().getDeviceList().values()) {
    ...
    private final AlarmManager.OnAlarmListener mRtxFinishRxFullAlarmAction =
            new AlarmManager.OnAlarmListener() {
                @Override
                public void onAlarm() {
                    onAlarmRtxFinish(6);
    ...
    public ReverseChargingController(
            ...
            Optional<UsbManager> optional2,
            @Main Executor executor,
            @Background Executor executor2,
        ...
        mDoesNfcConflictWithWlc =
                context.getResources().getBoolean(R.bool.config_nfc_conflict_with_wlc);
        ...
        int[] intArray =
                context.getResources()
                        .getIntArray(R.array.config_nfc_conflict_with_usb_audio_vendorid);
        mNfcUsbVendorIds = intArray;
        int[] intArray2 =
                context.getResources()
                        .getIntArray(R.array.config_nfc_conflict_with_usb_audio_productid);
        ...
        mDoesNfcConflictWithUsbAudio =
                context.getResources().getBoolean(R.bool.config_nfc_conflict_with_usb_audio);
    }
    ...
    private final AlarmManager.OnAlarmListener mReconnectedTimeoutAlarmAction =
            new AlarmManager.OnAlarmListener() {
                @Override
                public void onAlarm() {
                    if (DEBUG) {
    ...
    private void checkAndChangeNfcPollingAgainstUsbAudioDevice(boolean z, UsbDevice usbDevice) {
        ...
        for (int i = 0; i < mNfcUsbVendorIds.length; i++) {
            if (usbDevice.getVendorId() == mNfcUsbVendorIds[i]
                    && usbDevice.getProductId() == mNfcUsbProductIds[i]) {
    ...
    private final AlarmManager.OnAlarmListener mAccessoryDeviceRemovedTimeoutAlarmAction =
            new AlarmManager.OnAlarmListener() {
                @Override
                public void onAlarm() {
                    if (DEBUG) {
                        Log.w(
                                ...
                                "mAccessoryDeviceRemovedTimeoutAlarmAction() timeout");
                    }
                    onAlarmRtxFinish(6);
                }
            };
    ...
    public void init(BatteryController batteryController) {
        ...
        if (mRtxChargerManagerOptional.isPresent()) {
            setRtxMode(false);
            mRtxChargerManagerOptional
                    .get()
                    .addIsDockPresentChangeListener(
                            new ReverseWirelessCharger.IsDockPresentChangeListener() {
                                @Override
            ...
            mRtxChargerManagerOptional
                    .get()
                    .addReverseChargingInformationChangeListener(
                            new ReverseWirelessCharger.ReverseChargingInformationChangeListener() {
                                @Override
            ...
            mRtxChargerManagerOptional
                    .get()
                    .addReverseChargingChangeListener(
                            new ReverseWirelessCharger.ReverseChargingChangeListener() {
                                @Override
    ...
    public void handleIntentForReverseCharging(Intent intent) {
        ...
        if (action.equals("android.intent.action.BATTERY_CHANGED")) {
            ...
            mLevel =
                    (int)
                            ((intent.getIntExtra("level", 0) * 100.0f)
                                    / intent.getIntExtra("scale", 100));
            int intExtra = intent.getIntExtra("plugged", 0);
            mPluggedAc = intExtra == 1;
            Log.i(
                    "ReverseChargingControl",
                    "handleIntentForReverseCharging(): rtx="
                            + (mReverse ? 1 : 0)
                            + " wlc="
                            + (mWirelessCharging ? 1 : 0)
                            + " plgac="
                            + (z2 ? 1 : 0)
                            + " ac="
                            + (mPluggedAc ? 1 : 0)
                            + " acrtx="
                            + (mStopReverseAtAcUnplug ? 1 : 0)
                            + " extra="
                            + intExtra
                            + " this="
                            + this);
            ...
            if (z3 && mWirelessCharging) {
                if (DEBUG) {
                    Log.d(
                            "ReverseChargingControl",
                            "handleIntentForReverseCharging(): wireless charging, stop");
                }
                ...
                if (!autoTurnOnEnabled) {
                    ...
                    if (DEBUG) {
                        Log.d(
                                "ReverseChargingControl",
                                "handleIntentForReverseCharging(): wired charging, start");
                    }
                ...
                if (DEBUG) {
                    Log.d(
                            "ReverseChargingControl",
                            "handleIntentForReverseCharging(): lower then battery threshold, stop");
                }
            ...
            if (usbDevice2 == null) {
                Log.w(
                        "ReverseChargingControl",
                        "handleIntentForReverseCharging() UsbDevice is null!");
                mIsUsbPlugIn = false;
                return;
            }
            ...
            if (mDoesNfcConflictWithUsbAudio
                    && (usbDevice = (UsbDevice) intent.getParcelableExtra("device")) != null) {
    ...
    private boolean isLowBattery() {
        int i =
                Settings.Global.getInt(
                                mContext.getContentResolver(), "advanced_battery_usage_amount", 2)
                        * 5;
        if (mLevel <= i) {
            Log.w(
                    "ReverseChargingControl",
                    "The battery is lower than threshold turn off reverse charging ! level : "
                            + mLevel
                            + ", threshold : "
                            + i);
            return true;
    ...
    public boolean isReverseSupported() {
        ...
        if (mRtxChargerManagerOptional.isPresent()) {
            ...
            Log.d(
                    "ReverseChargingControl",
                    "isReverseSupported(): mRtxChargerManagerOptional is not present!");
            return false;
        }
    }
    ...
    private void setReverseStateInternal(boolean z, int i) {
        ...
        Log.i(
                "ReverseChargingControl",
                "setReverseStateInternal(): rtx=" + (z ? 1 : 0) + ",reason=" + i);
        if (z && !isReverseOn()) {
            if (mPowerSave) {
                return;
    ...
    private long getRtxTimeOut(int i) {
        ...
        String str =
                SystemProperties.get(mStopReverseAtAcUnplug ? "rtx.ac.timeout" : "rtx.timeout");
    ...
    private void onDockPresentChanged(final Bundle bundle) {
        if (DEBUG) {
            Log.d(
                    "ReverseChargingControl",
                    "onDockPresentChanged(): rtx ="
                            + (mReverse ? 1 : 0)
                            + " type="
                            + ((int) bundle.getByte("key_dock_present_type"))
                            + " bundle="
                            + bundle
                            + " this="
                            + this);
                ...
                new Runnable() {
                    ...
                    public void run() {
                        if (DEBUG) {
                            Log.d(
                                    "ReverseChargingControl",
                                    "onDockPresentChangedOnMainThread(): rtx ="
                                            + (mReverse ? 1 : 0)
                                            + " type="
                                            + ((int) bundle.getByte("key_dock_present_type"))
                                            + " bundle="
                        ...
                        mName =
                                bundle.getByte("key_dock_present_type") == 4
                                        ? mContext.getString(
                                                R.string.reverse_charging_device_name_text)
                                        : null;
                    }
                });
    }
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (!mReverse && mWirelessCharging && i2 == 0 && i5 > 0) {
                            ...
                            if (mCurrentRtxMode != 1
                                    && i2 == 1
                                    && !mReverse
                                    && mDoesNfcConflictWithWlc
                                    && !mRestoreWlcNfcPollingMode) {
                                enableNfcPollingMode(false);
                                mRestoreWlcNfcPollingMode = true;
                            }
                            mCurrentRtxMode = i2;
                                ...
                                if (!z2) {
                                    ...
                                    if (mCurrentRtxReceiverType != i4) {
                                        if (z) {
                                            Log.d(
                                                    "ReverseChargingControl",
                                                    "receiver type updated: "
                                                            + mCurrentRtxReceiverType
                                                            + " "
                                                            + i4);
                                        }
                            ...
                            if (z3 && mRtxLevel == -1) {
                                ...
                                if (z) {
                                    Log.d(
                                            "ReverseChargingControl",
                                            "onReverseStateChangedOnMainThread(): rtx="
                                                    + (mReverse ? 1 : 0)
                                                    + ", Rx fully charged, setRtxTimer,"
                                                    + " REVERSE_FINISH_RX_FULL");
                                }
                                setRtxTimer(1, 0L);
                            }
                        }
    ...
    private void fireReverseChanged() {
        synchronized (mChangeCallbacks) {
            ...
            for (int i = 0; i < size; i++) {
                ((ReverseChargingChangeCallback) arrayList.get(i))
                        .onReverseChargingChanged(mReverse, mRtxLevel, mName);
            }
        }
    }
    ...
    private void setRtxTimer(int i, long j) {
        if (i == 0) {
            ...
            mAlarmManager.setExact(
                    ...
                    SystemClock.elapsedRealtime() + j,
                    "ReverseChargingControl",
                    mCheckNfcConflictWithUsbAudioAlarmAction,
                    null);
        } else if (i == 3) {
            mAlarmManager.setExact(
                    2,
                    SystemClock.elapsedRealtime() + j,
                    "ReverseChargingControl",
                    mReconnectedTimeoutAlarmAction,
                    null);
        } else if (i != 4) {
        } else {
            mAlarmManager.setExact(
                    ...
                    SystemClock.elapsedRealtime() + j,
                    "ReverseChargingControl",
                    mAccessoryDeviceRemovedTimeoutAlarmAction,
                    null);
        }
    }
    ...
    private void playSoundIfNecessary(boolean z, int i) {
        ...
        if (!z2 && z) {
            if (DEBUG) {
                Log.d(
                        "ReverseChargingControl",
                        "playSoundIfNecessary() play start charging sound: "
                                + z
                                + ", accType : "
                                + i
                                + ", mStartReconnected : "
            ...
            if (z3) {
                Log.d(
                        "ReverseChargingControl",
                        "playSoundIfNecessary() play end charging sound: "
                                + z
                                + ", accType : "
                                + i
                                + ", mStartReConnected : "
        ...
        if (!TextUtils.isEmpty(str)) {
            playSound(
                    RingtoneManager.getRingtone(
                            mContext, new Uri.Builder().scheme("file").appendPath(str).build()));
        }
    }
