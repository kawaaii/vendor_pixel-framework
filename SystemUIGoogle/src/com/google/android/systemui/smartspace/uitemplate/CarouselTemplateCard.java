...
public class CarouselTemplateCard extends BcSmartspaceCardSecondary {
    ...
    public final void onFinishInflate() {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            if (i2 == 0) {
                ...
                ((ConstraintLayout.LayoutParams) layoutParams).startToEnd =
                        constraintLayout.getId();
            }
            if (i2 == 3) {
                ((ConstraintLayout.LayoutParams) layoutParams).endToEnd = 0;
            } else {
                ((ConstraintLayout.LayoutParams) layoutParams).endToStart =
                        constraintLayout2.getId();
            }
    ...
    public final boolean setSmartspaceActions(
        ...
        CarouselTemplateData templateData =
                (CarouselTemplateData) smartspaceTarget.getTemplateData();
        if (templateData != null && templateData.getCarouselItems() != null) {
                                    ...
                                    .filter(
                                            new Predicate() { // from class:
                                                ...
                                                public final boolean test(Object obj) {
                                                    boolean z;
                                                    CarouselTemplateData.CarouselItem carouselItem =
                                                            (CarouselTemplateData.CarouselItem) obj;
                                                    int i3 = CarouselTemplateCard.clinit;
                                                    if (carouselItem.getImage() != null
                                                            && carouselItem.getLowerText() != null
                                                            && carouselItem.getUpperText()
                                                                    != null) {
                                                        z = true;
                                                    } else {
                                                        z = false;
            ...
            if (intExact < 4) {
                ...
                Log.w(
                        ...
                        String.format(
                                Locale.US, "Hiding %d incomplete column(s).", Integer.valueOf(i3)));
